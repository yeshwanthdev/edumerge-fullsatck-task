...
import { breadcrumbs, columns, customDataSource, deleteSingleRecord } from '@pages/Campus/api';
...
const ListPage = () => {
	...
	const isCreateDisabled = !RM.helper().isAuthorized(RM.commonConfig.arnConstants.CAMPUS_CREATE);
	const isDeleteDisabled = !RM.helper().isAuthorized(RM.commonConfig.arnConstants.CAMPUS_DELETE);
	...
	const actions = [
		{
			...
			onClick: async () => navigate('/campus/createNewRecord'),
		},
		{
			label: 'Delete',
			variant: 'outlined',
	...
	const handleRowClick = (params) => {
		navigate(`/campus/${params.row.code}`);
	};
