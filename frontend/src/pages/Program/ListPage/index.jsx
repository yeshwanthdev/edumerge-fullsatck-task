...
import { breadcrumbs, columns, customDataSource, deleteSingleRecord } from '@pages/Program/api';
...
const ListPage = () => {
	...
	const isCreateDisabled = !RM.helper().isAuthorized(RM.commonConfig.arnConstants.PROGRAM_CREATE);
	const isDeleteDisabled = !RM.helper().isAuthorized(RM.commonConfig.arnConstants.PROGRAM_DELETE);
	...
	const actions = [
		{
			...
			onClick: async () => navigate('/program/createNewRecord'),
		},
		{
			label: 'Delete',
			variant: 'outlined',
	...
	const handleRowClick = (params) => {
		navigate(`/program/${params.row.code}`);
	};
