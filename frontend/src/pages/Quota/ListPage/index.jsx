...
import { breadcrumbs, columns, customDataSource, deleteSingleRecord } from '@pages/Quota/api';
...
const ListPage = () => {
	...
	const isCreateDisabled = !RM.helper().isAuthorized(RM.commonConfig.arnConstants.QUOTAS_CREATE);
	const isDeleteDisabled = !RM.helper().isAuthorized(RM.commonConfig.arnConstants.QUOTAS_DELETE);
	...
	const actions = [
		{
			...
			onClick: async () => navigate('/quota/createNewRecord'),
		},
		{
			label: 'Delete',
			variant: 'outlined',
	...
	const handleRowClick = (params) => {
		navigate(`/quota/${params.row.code}`);
	};
