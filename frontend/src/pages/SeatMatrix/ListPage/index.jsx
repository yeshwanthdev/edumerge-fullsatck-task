...
import { breadcrumbs, columns, customDataSource, deleteSingleRecord } from '@pages/SeatMatrix/api';
...
const ListPage = () => {
	...
	const isCreateDisabled = !RM.helper().isAuthorized(RM.commonConfig.arnConstants.SEAT_MATRIX_CREATE);
	const isDeleteDisabled = !RM.helper().isAuthorized(RM.commonConfig.arnConstants.SEAT_MATRIX_DELETE);
	...
	const actions = [
		{
			...
			onClick: async () => navigate('/seatMatrix/createNewRecord'),
		},
		{
			label: 'Delete',
			variant: 'outlined',
	...
	const handleRowClick = (params) => {
		navigate(`/seatMatrix/${params.row.code}`);
	};
